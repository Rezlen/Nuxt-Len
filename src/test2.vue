...
<style scoped>
  ...
  /* Define column styles for new fields */
  .MemberIDCol, .PersonPicCol, .FirstNameCol, .LastNameCol, .MembershipTypeCol, .TotalMembershipSpentCol, .AgeCol, 
  .GenderCol, .BusinessNameCol, .BusinessRevenueCol, .JobPositionCol, .SalaryCol, .BizCategoryCol, .ExhibitedCol, 
  .EventSpentCol, .VisitedCol, .ListedNeedsCol, .ListedOffersCol, .AdvertSpentCol, .PeopleSatisfiedNeedsCol, 
  .PeopleRequestedOffersCol, .InvestorsAdvertsCol, .PitchingsCol, .BizMentorCol, .TotalSpentCol, .MobileNoCol, 
  .EmailCol, .BizCountryCol, .BizCityCol, .ConnectionsCol, .NoEmployeesCol, .JoinedCol, .LastLoggedInCol, 
  .NoLoggedInCol, .FullProfileSeenCol, .ActionCol {
