    ...
    <IonRow class="mainRow">
      ...
      <IonItem class="Head">
        ...
        <IonCol class="title label">
          30 Minutes FREE Business Advice finding If or how I can help you
        </IonCol>
      ...
      <IonItem class="Head">
        ...
        <IonCol class="title label boxNumber ">
          ...
          Hour(s) Business Advice Session</IonCol>
        <IonCol class="DatePrice">
...
export default defineComponent({
  name: 'BusinessAdviceBestOffers7CategoriesFormComponent',
  components: {
    IonInput,
    IonItem,
    IonCheckbox,
