    ...
    <IonRow class="NONscrollingRow">
      ...
      <IonRow class="scrollingRow" ref="scrollableContainer">
        ...
        <IonRow class="TitleRow">
          ...
          <IonCol class="accountantTotalMembershipSpentCol topBorder" @click="sortMembers('accountantTotalMembershipSpent')">Accountant Total Membership Spent<IonIcon :icon="sortIcon('accountantTotalMembershipSpent')" class="sort-icon" /></IonCol>
          <IonCol class="accountantAllSpentCol topBorder" @click="sortMembers('accountantAllSpent')">Accountant Total Spent<IonIcon :icon="sortIcon('accountantAllSpent')" class="sort-icon" /></IonCol>
          <!-- Accountant Section -->
          <!-- Accounting Section -->
        ...
        <IonRow v-for="member in paginatedMembers" :key="member.id" class="DataRow" :class="{ selected: selectedRow === member.id }" @click="selectRow(member.id)">
          ...
          <IonCol class="accountantTotalMembershipSpentCol">{{ member.accountantTotalMembershipSpent }}</IonCol>
        ...
        <IonRow class="TotalRow">
          ...
          <IonCol class="accountantTotalMembershipSpentCol">{{ accountantTotalMembershipSpent }}</IonCol>
...
<script lang="ts">
  ...
  interface Member {
    ...
    accountantTotalMembershipSpent: number;
      ...
      const members = ref<Member[]>([
        {
          ...
          accountantTotalMembershipSpent: 500,
...
// back button does not wor, fix itk
    ...
    //  * Computes the total price of all members.
      ...
      // <!-- Accountant Section -->
      const accountantTotalMembershipSpent = computed(() => filteredMembers.value.reduce((sum, member) => sum + member.accountantTotalMembershipSpent, 0));
    ...
    //  * Exports the table data to a CSV file.
      const exportTable = () => {
        const csvContent = [
          [
            'Member ID', 'personPic', 'firstName', 'lastName', 'membershipType','accountantTotalMembershipSpent', 'allSpent',
            // <!-- Accountant Section-->
              'accountantPic', 'accountantFirstName', 'accountantBizName', 'accountantMembershipType', 'accountantAllSpent',
            // <!-- Accountant Section-->
          ...
          ...filteredMembers.value.map(member => [
            ...
            // <!-- Accountant Section-->
            member.accountantPic, member.accountantFirstName, member.accountantBizName, member.accountantMembershipType,  member.accountantTotalMembershipSpent,  member.accountantAllSpent, 
            // <!-- Accountant Section-->
            //  Accounting Section
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th>accountantTotalMembershipSpent</th>
                ...
                <tbody>
                  ${paginatedMembers.value.map((member, index) => `
                    <tr class="${index % 2 === 0 ? 'even-row' : 'odd-row'}">
                      ...
                      <td>${member.accountantTotalMembershipSpent}</td>
                  ...
                  <tr class="TotalRow">
                    ...
                    <td>${accountantTotalMembershipSpent.value}</td>
      ...
      return {
        ...
        allSpent,
        // Accountant Section
        accountantTotalMembershipSpent,
        accountantAllSpent,
        // Accountant Section
