    ...
    <IonRow class="NONscrollingRow">
      ...
      <IonRow class="scrollingRow" ref="scrollableContainer">
        ...
        <IonRow class="TitleRow">
          ...
          <IonCol class="messageNoCol" @click="sortMembers('messageNo')">MessageNo <IonIcon :icon="sortIcon('messageNo')" class="sort-icon" /></IonCol>
          <IonCol class="messageDescriptionCol" @click="sortMembers('messageDescription')">Message Description <IonIcon :icon="sortIcon('messageDescription')" class="sort-icon" /></IonCol>
          <IonCol class="repliedCol" @click="sortMembers('replied')">Replied <IonIcon :icon="sortIcon('replied')" class="sort-icon" /></IonCol>
          <IonCol class="messagedDateCol" @click="sortMembers('messagedDate')">Messaged Date <IonIcon :icon="sortIcon('messagedDate')" class="sort-icon" /></IonCol>
          <IonCol class="repliedDateCol" @click="sortMembers('repliedDate')">Replied Date <IonIcon :icon="sortIcon('repliedDate')" class="sort-icon" /></IonCol>
          <IonCol class="adminNameCol" @click="sortMembers('adminName')">Admin Name <IonIcon :icon="sortIcon('adminName')" class="sort-icon" /></IonCol>
          <IonCol class="viewReplyCol" @click="sortMembers('viewReply')">View & Reply <IonIcon :icon="sortIcon('viewReply')" class="sort-icon" /></IonCol>
...
.TitleRow .messageNoCol,
.TitleRow .messageDescriptionCol,
.TitleRow .repliedCol,
.TitleRow .messagedDateCol,
.TitleRow .repliedDateCol,
.TitleRow .adminNameCol,
.TitleRow .viewReplyCol {
