  ...
  <IonGrid class="Grid">
    ...
    <IonRow class="DisplayComponentRow">
      ...
      <IonCol v-show="selectedTab === 'PitchingPresentationWorkshop'" class="PitchingPresentationWorkshop">
        ...
        <p class="CenterPositions">People want to know blow about your pitching, workshop or presentation & find it later. So pls fill below.</p>
      ...
      <IonCol v-show="selectedTab === 'UpSelling'" class="UpSelling">
        ...
        <IonRow class="UpSellingService checkbox-text">
          <p class="CenterPositions " > Tick Below if You Like to Receive a Video of Your Pitching!</p>
