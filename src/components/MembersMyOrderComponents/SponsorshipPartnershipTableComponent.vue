    ...
    <IonRow class="NONscrollingRow">
      ...
      <IonRow class="scrollingRow" ref="scrollableContainer">
        ...
        <IonRow class="TitleRow">
          ...
          <IonCol class="sponsorshipPartnershipTitleCol" @click="sortMembers('sponsorshipPartnershipTitle')">Sponsorship Partnership Title <IonIcon :icon="sortIcon('sponsorshipPartnershipTitle')" class="sort-icon" /></IonCol>
          <IonCol class="sponsorshipPartnershipSeenCol" @click="sortMembers('sponsorshipPartnershipSeen')">Sponsorship Partnership Seen <IonIcon :icon="sortIcon('sponsorshipPartnershipSeen')" class="sort-icon" /></IonCol>
          <IonCol class="sponsorshipPartnershipListViewCol" @click="sortMembers('sponsorshipPartnershipListView')">Sponsorship Partnership List View <IonIcon :icon="sortIcon('sponsorshipPartnershipListView')" class="sort-icon" /></IonCol>
          <IonCol class="CostCol" @click="sortMembers('cost')">Sponsorship Partnership Cost <IonIcon :icon="sortIcon('cost')" class="sort-icon" /></IonCol>
          <!-- Sponsorship Partnership Section -->
