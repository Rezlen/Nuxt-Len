<template>
  <IonGrid>
    ...
    <IonRow class="DisplayComponentRow">
      ...
      <IonCol v-show="selectedTab === 'Adverts'" class="Adverts">
      </IonCol>
      <!-- Membership Tab here ####################################-->
      ...
      <IonCol v-show="selectedTab === 'MemberInvestmentApplicationComponent'" class="MemberMemberInvestmentApplicationComponentComponent">
