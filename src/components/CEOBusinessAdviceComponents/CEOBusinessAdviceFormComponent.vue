    ...
    <IonRow class="mainRow">
      ...
      <IonItem class="Head">
        ...
        <IonCol class="title label">
          One Month Logo Display On LEN's Meetup Groups with 30,000+ members
        </IonCol>
        <IonCol class="DatePrice">
        ...
        <IonCol class="description label">
          <li>
            We place your logo, an offer & your link on the left side of all our Meetup Groups with 30,000+ members so at least 30,000+ members see it, plus many who are not our members & check our groups regularly!
          </li>
        </IonCol>
      </IonItem>
    </IonRow>
